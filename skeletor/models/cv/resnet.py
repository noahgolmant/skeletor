...
def ResNet18(num_classes=10, in_channels=3, **kwargs):
    return ResNet(BasicBlock, [2,2,2,2], num_classes=10,
                  in_channels=in_channels)

def ResNet34(num_classes=10, in_channels=3, **kwargs):
    return ResNet(BasicBlock, [3,4,6,3], num_classes=10,
                  in_channels=in_channels)

def ResNet50(num_classes=10, in_channels=3, **kwargs):
    return ResNet(Bottleneck, [3,4,6,3], num_classes=10,
                  in_channels=in_channels)

def ResNet101(num_classes=10, in_channels=3, **kwargs):
    return ResNet(Bottleneck, [3,4,23,3], num_classes=10,
                  in_channels=in_channels)

def ResNet152(num_classes=10, in_channels=3, **kwargs):
